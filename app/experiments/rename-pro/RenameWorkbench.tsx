...
export default function RenameWorkbench() {
  ...
  async function download() {
    ...
    try {
      ...
      setMessage(rows.length === 1 ? "Your renamed copy is downloading. The original file is unchanged." : `Your ZIP with ${rows.length} renamed copies is downloading. Your original files are unchanged.`);
  ...
  return <div className="rename-workbench">
    <QuickStart>Choose or drop files, pick your rename rules, check the new names in the preview, then download. You get renamed copies; a browser can’t rename your original files in place.</QuickStart>
    ...
    <div className="rename-layout">
      <section className="rename-rules"><p className="eyebrow">02 / Make it yours</p><h2>Rename rules</h2><p className="field-hint">Use any mix of rules. The preview updates as you type.</p>
