...
import { useFeedbackEntries } from "../experiment-components/feedback-client";
...
export default function ExperimentBrowser({ initialCategory }: { initialCategory: string }) {
  ...
  const feedback = useFeedbackEntries(experiments.map(e => e.slug));
